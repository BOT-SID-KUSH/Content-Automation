...
import io
import base64
from logics.content_mapping.content_mapping import extract_content_mapping
...
def main():
    st.title("Content Mapping Generator")
    ...
    with col2:
        st.subheader("Format : ")
        with open('logics/content_mapping/format.json', 'r') as f:
